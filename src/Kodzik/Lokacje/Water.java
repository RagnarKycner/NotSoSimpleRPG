...
public class Water extends Location{
    ...
    public Water(String name, int level, String[] monsterNames, String[][] actionsNames) {
        this.counter = 0;
        this.name = name;
        this.level = level;
    ...
    public void enter(Player player) {
        player.setAttmod(1f);
        player.setDefmod(0.8f);
        this.player = player;
        System.out.println("Wchodzisz do "+ name + " gdzie jest ciemno i mokro, " +
                "orientujesz sie ze jestes po kolana w 'wodzie'.");
    }


    @Override
    public void encounter() {
        System.out.println( "\nSpotykasz " + monsters.get(counter).getName());
    }
