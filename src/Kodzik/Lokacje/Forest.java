...
public class Forest extends Location{
    ...
    public Forest(String name, int level, String[] monsterNames, String[][] actionsNames) {
        this.counter = 0;
        this.name = name;
        this.level = level;
    ...
    public void enter(Player player) {
        player.setAttmod(0.8f);
        player.setDefmod(1f);
        this.player = player;
        System.out.println("Idziesz do "+ name + " gdzie ciezko jest cos zobaczyc.");
    }
